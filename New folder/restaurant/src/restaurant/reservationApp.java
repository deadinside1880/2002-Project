...
public class reservationApp {
  ...
  public void reservations()throws IOException, ParseException{
  ...
  public void updateReservation(String name)throws IOException{
    ...
    if(flag==1)
    {
      ...
      case 2:
        ...
        temp.setDate(date);
        boolean reserve=tb.canReserve(pax,temp.getDate(),temp.getTime());
        if(reserve == true)
        {
          allres.add(temp);
          tempTable.reservations.add(temp);
      ...
      case 3:
        ...
        time1=getTimeInputString(time);
        temp.setTime(time1);
        reserve=tb.canReserve(pax,temp.getDate(),temp.getTime());
        if(reserve == true)
        {
          allres.add(temp);
          tempTable.reservations.add(temp);
      ...
      case 5:
        ...
        noOfPax=sc.nextInt();
        reserve=tb.canReserve(noOfPax,temp.getDate(),temp.getTime());
        if(reserve == true)
        {
