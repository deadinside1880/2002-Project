...
public class Menu {
	...
	private BufferedReader getBR(String filename)throws FileNotFoundException, IOException{
	 ...
	 public void promoOP() throws IOException{
	        System.out.println("What would you like to do?");
	        System.out.println("(1) Add an Promo Item");
	        System.out.println("(2) Remove a Promo Item");
	        System.out.println("(3) Update a Promo Item");
	        System.out.println("(4) View Menu");
	        Scanner AT=new Scanner(System.in);
	        int choice = AT.nextInt();
	        ...
	        try{
	            ...
	            switch(choice){
	                case 1:
	                    ...
	                    System.out.println("Enter price");
	                    metadata[2] = AT.nextLine();
	                    System.out.println("Enter promo items");
	                    metadata[3] = AT.nextLine();
	                    addPromotionItem(metadata[0], metadata[1], metadata[3], Double.parseDouble(metadata[2]));
	                    break;
	                case 2:System.out.println("Enter promotion name:");
	                    String name = AT.nextLine();
	                    removePromoItem(name);
	                    break;
	                case 3: System.out.println("Enter name of the item to be edited ()");
	                    String nam = AT.nextLine();
	                    updatePromo(nam);
	                    break;
	                case 4: 
